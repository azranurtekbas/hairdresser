...
namespace haircaredeneme.Controllers
{
    public class RandevularController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("randevuId,Tarih,saat,CalisanId,musteriId,islemId,Durum")] Randevu randevu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("randevuId,Tarih,saat,CalisanId,musteriId,islemId,Durum")] Randevu randevu)
        {
